...
class CellV2Commands(object):
    ...
    def _compare_instance(self, ctxt, uuid, mapping, fix):
        ...
        def _diff_almost_equals(diff):
            ...
            # e.g. ('change', ['nova_object.data', 'keypairs', 'nova_object.data', 'objects', 0, 'nova_object.data', 'created_at'], ('2014-04-10T04:14:01Z', '2017-10-24T02:53:16Z'))
            elif diff[0] == 'change' and \
                diff[1][1] == 'keypairs' and \
                diff[1][6] == 'created_at':
                return True
            # (3): flavor or migration_context object version different
            # e.g. ('change', ['nova_object.data', 'flavor', 'nova_object.version'], (u'1.2', u'1.1'))
            elif diff[0] == 'change' and \
                len(diff[1]) == 3 and \
                (diff[1][1] == 'flavor' or \
            ...
            # e.g. ('change', ['nova_object.data', 'hostname'], (None, u'server-579a7944-5436-4451-88fa-57832640fe91'))
            elif diff[0] == 'change' and \
            ...
            # e.g. ('change', ['nova_object.data', 'created_at'], ('2019-08-04T23:43:52Z', '2019-08-04T23:43:51Z'))
            elif diff[0] == 'change' and \
                diff[1][1] == 'created_at':
            ...
            # e.g. ('add', ['nova_object.data', 'system_metadata'], [(u'password_0', u'<TRIMMED>'), ... ])
            elif diff[0] == 'add' and \
                diff[1][1] == 'system_metadata' and \
                'password_0' in diff[2][0] :
                return True
            # (6): change in keypair, ignore it and respect what compute has
            # e.g. ('change', ['nova_object.data', 'keypairs', 'nova_object.data', 'objects', 0, 'nova_object.data', 'public_key'], (u'<KEY1>', u'<KEY2''))
            elif diff[0] == 'change' and \
                diff[1][1] == 'keypairs':
                return True
        ...
        def _fix_instance(inst, cinst, diff):
            ...
            # e.g. ('change', ['nova_object.data', 'display_name'], (u'small', u'Server 579a7944-5436-4451-88fa-57832640fe91')
            ...
            # e.g. ('remove', ['nova_object.data', 'keypairs', 'nova_object.data', 'objects'], [<KEYPAIRS>])
            ...
            # e.g. ('remove', ['nova_object.data', 'system_metadata'], [(u'network_allocated', u'True')])
            elif diff[0] == 'remove' and \
            ...
            # e.g. ('remove', ['nova_object.data', 'metadata'], [(u'role', u'master')])
            elif diff[0] == 'remove' and \
                diff[1][1] == 'metadata':
        ...
        ignore_attrs = ['fault', 'services', 'pci_devices', 'migration_context']
        ...
        if objects.base.obj_equal_prims(inst, cinst, ignore_keys):
            ...
            print("Instance {} attrs almost equal in api and compute".format(uuid))
            return True
