            ...
            if (image_id is not None and
                ...
                try:
                    ...
                    if (min_compute_version >=
                        BFV_RESERVE_MIN_COMPUTE_VERSION) and self.cell_type != 'api':
...
def target_host_cell(fn):
    ...
    def targeted(self, context, host, *args, **kwargs):
        ...
        nova_context.set_target_cell(context, mapping.cell_mapping, cell_v1_enable=False)
...
def _find_service_in_cell(context, service_id=None, service_host=None):
    ...
    for cell in CELLS:
        ...
        try:
            with nova_context.target_cell(context, cell, cell_v1_enable=False) as cctxt:
    ...
    if service:
        ...
        nova_context.set_target_cell(context, found_in_cell, cell_v1_enable=False)
        return service
    else:
...
class HostAPI(base.Base):
    ...
    def service_get_all(self, context, filters=None, set_zones=False,
        ...
        if all_cells:# and not CONF.cells.enable:
            services = []
            services = list(objects.ServiceList.get_all(context, disabled,
                                                   set_zones=set_zones))

            service_dict = nova_context.scatter_gather_all_cells(context,
                    objects.ServiceList.get_all, disabled, set_zones=set_zones, cell_v1_enable=False)
